...
export default function CancelOrder (props) {
    ...
    return(
        ...
        <View style={{ flex: 1,top:80 }}>{renderFlatList(products)}</View>
        <View style={{justifyContent:'center',alignItems:'center'}}>
        <TouchableOpacity onPressIn={()=>cancelorder()}>
            <Text style={{color:'red',borderWidth:0.3,padding:8,borderColor:'red',width:100,bottom:200}}>Cancel Order</Text>
        </TouchableOpacity>
        </View>
        </View>
        </View>

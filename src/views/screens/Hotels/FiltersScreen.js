...
const FiltersScreen = (props) => {
  ...
  console.log("sabaris props",props.route.params.lat)
...
const retrieveData = async () => {
 ...
 console.log(`${baseUrl}/get-delivery-restaurants?latitude=${props.route.params.lat}&longitude=${props.route.params.long}&category_ids=${itemsid}`)

    fetch(`${baseUrl}/get-delivery-restaurants?latitude=${props.route.params.lat}&longitude=${props.route.params.long}&category_ids=${itemsid}` ,
    {
      method: 'POST', 
    ...
    <View style={styles.categories}>
      ...
      horizontal={true}
       showsHorizontalScrollIndicator={false}>
        <View style={{paddingRight: 100,flexDirection:'row'}} >

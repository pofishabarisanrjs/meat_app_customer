...
import {Button, StyleSheet, Text, View,Image,Alert, Pressable} from 'react-native';
    ...
    <View style={styles.container}>
      ...
      top:30,justifyContent:'center'
        ...
        <View style={styles.word}>
          <TouchableOpacity style={{bottom:6}} onPress={()=>navigation.navigate('ManageAddress')}>
            <View>
            <Image 
...
<View style={{width:'100%',height:230,top:40}}>
      ...
      <View style={{top:20,flexWrap:'wrap',}}>
        <TouchableOpacity style={styles.helpsec} onPress={()=>navigation.navigate('Webview',{
          url : `${domainUrl}return-policy`
        })}>
      ...
      <TouchableOpacity style={styles.helpsec} onPress={()=>navigation.navigate('Webview',{
          url : `${domainUrl}terms-conditions`
        })}>
      <Text style= {{color:'black'}}>Conditions of use</Text>
      </TouchableOpacity>
     
      <TouchableOpacity style={styles.helpsec} onPress={()=>navigation.navigate('Webview',{
          url : `${domainUrl}payment-info`
        })}>
      ...
      <View style={{width:'100%',height:200,top:40}}>
        <Pressable style={styles.log} onPress={toggleOverlay}>
